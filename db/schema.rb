...
ActiveRecord::Schema[7.2].define(version: 2026_08_17_130000) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "utm_term"
    t.string "customer_email"
    t.string "idworks_sales_channel"
    ...
    t.index ["idworks_sales_channel"], name: "index_orders_on_idworks_sales_channel"
  ...
  create_table "tenants", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "tv_token"
    t.string "testimonials_public_token"
    t.index ["slug"], name: "index_tenants_on_slug", unique: true
    t.index ["testimonials_public_token"], name: "index_tenants_on_testimonials_public_token", unique: true
    t.index ["tv_token"], name: "index_tenants_on_tv_token", unique: true
  end

  create_table "testimonial_bulk_imports", force: :cascade do |t|
    t.bigint "tenant_id", null: false
    t.string "filename"
    t.string "status", default: "pending", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tenant_id"], name: "index_testimonial_bulk_imports_on_tenant_id"
  end
  ...
  create_table "testimonials", force: :cascade do |t|
    ...
    t.jsonb "tiktok_metadata", default: {}, null: false
    t.datetime "approved_at"
    t.datetime "published_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_testimonials_on_product_id"
    t.index ["tenant_id", "product_id"], name: "index_testimonials_on_tenant_id_and_product_id"
    t.index ["tenant_id", "source_type"], name: "index_testimonials_on_tenant_id_and_source_type"
    t.index ["tenant_id", "status"], name: "index_testimonials_on_tenant_id_and_status"
  ...
  add_foreign_key "testimonial_bulk_imports", "tenants"
